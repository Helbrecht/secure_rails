class ParseManager
	...
	def self.refresh_data(params = {})
		...
		ParseManager::DangerRulezSk.new.parse_sources
		puts "DangerRulezSk done"
		...
		puts "Phishtank done"
		ParseManager::Cruzit.new.parse_sources
		puts "Cruzit done"
		...
		puts "Botscout done"
		ParseManager::Cert.new.parse_sources
		puts "Cert done"
		ParseManager::Chaos.new.parse_sources
		puts "Chaosreigns done"
		ParseManager::Cinscore.new.parse_sources
		puts "Cinscore done"
